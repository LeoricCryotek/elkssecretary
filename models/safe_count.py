# -*- coding: utf-8 -*-
"""Safe Count — count the contents of the lodge safe.

Similar to a till count but for the safe.  The Secretary counts the safe
at the end of the night after all tills have been counted and deposits
prepared.
"""
...
class ElksSafeCount(models.Model):
    ...
    name = fields.Char(
        "Description", default="Safe Count", tracking=True,
    )
